...
chats = {}
day = 86400
bot_id = 319891726 -- Your Bot USER_ID
sudo_users = {2190201071,000000000}
  -----------------------------------------------------------------------------------------------
                                     -- start functions --
  -----------------------------------------------------------------------------------------------
   ...
   tdcli_function ({
	...
	local mutept = {string.match(text, "^[#/!](mute) (.*)$")} 
	  ...
	  if mutept[2] == "webpage" then
         send(msg.chat_id_, msg.id_, 1, '> *WebLink* posting has been *Locked*', 1, 'md')
	...
	local unmutept = {string.match(text, "^[#/!](unmute) (.*)$")} 
	  ...
	  if unmutept[2] == "webpage" then
         send(msg.chat_id_, msg.id_, 1, '> *WebLink* posting has been *Unlocked*', 1, 'md')
